...
#define F_CPU 12000000L    /* evaluation board runs on 12MHz */
 ...
 */
#define USB_CFG_VENDOR_NAME     'd', 'e', 'v', '.', 'u', 'k', 'r', 'i', 'n', 't', 'e', 'l', 't', 'e', 'c', 'h', '.', 'c', 'o', 'm'
 ...
 * details. 
 */
#define USB_CFG_DEVICE_NAME     'C', 'o', 'n', 't', 'r', 'o', 'l', ' ', 'b', 'o', 'a', 'r', 'd'
 ...
 */
#define USB_CFG_DEVICE_CLASS    0xff   /* specify the class at the interface level */
#define USB_CFG_DEVICE_SUBCLASS 0
/* See USB specification if you want to conform to an existing device class.
 */
#define USB_CFG_INTERFACE_CLASS     0       /* HID class */
